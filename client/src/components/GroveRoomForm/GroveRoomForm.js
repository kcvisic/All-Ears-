            ...
            <div className="modal-content">
              ...
              <div className="modal-body" id="myModalBody">
                <div className="form-group">
                  ...
                  <input className="form-control ui-autocomplete-input" onChange={this.handleInputChange} name="song" id="initialSong" />
                  <label className="modal-inline-text">Enter Artist</label>
                  <input className="form-control ui-autocomplete-input" onChange={this.handleInputChange} name="artist" id="initialArtist" />
                  <label className="modal-inline-text">Groove Room Name</label>
                  <input className="form-control" onChange={this.handleInputChange} type="text" name="grooveRoomInput" id="grooveRoomInput" />
                </div>
              </div>
